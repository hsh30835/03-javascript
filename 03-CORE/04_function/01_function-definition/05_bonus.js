...
2.Reference to the outer enviroment(외부 환경에 대한 참조) : 현재 Lexical Enviroment가 포함된 외부
Lexical Enviroment에 대한 참조를 포함하고 이를 통해 중첩된 스코프(스코프 체인)이 형성되며 변수나 함수를
찾을 때 외부 Lexical Enviroment로 계속 해서 올라가게 된다.
*/
